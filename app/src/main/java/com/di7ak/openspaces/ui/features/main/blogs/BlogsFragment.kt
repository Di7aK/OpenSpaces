...
import com.di7ak.openspaces.databinding.FragmentBlogsBinding
import com.di7ak.openspaces.ui.base.BaseFragment
import com.di7ak.openspaces.ui.features.main.comments.CommentsFragment
import com.di7ak.openspaces.ui.features.main.lenta.LentaAdapter
...
@AndroidEntryPoint
class BlogsFragment : BaseFragment(), LentaAdapter.LentaItemListener {
    companion object {
        const val ARG_USER = "user"
    }
    private var binding: FragmentBlogsBinding by autoCleared()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.user = arguments?.getString(ARG_USER) ?: ""
